...
describe('GET /tweet/:id', () => {
  ...
  describe('get tweet likers', () => {
    ...
    test('Should mock tweet', async () => {
      ...
      expect(res.status).toBe(200);
      expect(res.body.likers).toHaveLength(0);
    });
    ...
    test('Should mock tweet like', async () => {
      ...
      expect(res.status).toBe(200);
      expect(res.body.likers).toHaveLength(1);
    });
  });
  ...
  describe('post tweet', () => {
    test('Can not retweet and reply together', async () => {
      ...
      const res = await Request(app)
        ...
        .set('authorization', 'Bearer abc123')
        .send({
          text: 'hello #AHMED @ahmed how are you',
          source: 'IPhone',
          replyToTweetId: '351f773f-f284-4522-8e55-a17b6ddb63ef',
          retweetedId: '351f773f-f284-4522-8e55-a17b6ddb63ef',
          sensitive: '',
  ...
  test('retweet twice', async () => {
    ...
    const retweetTweet = {
      createdAt: new Date(),
      id: '351f773f-f284-4522-8e55-a27b6ddb63ef',
      text: 'Hello',
      userId: '251f773f-f284-4522-8e55-a17b6ddb63ef',
      readCount: 1,
      replyCount: 1,
    ...
    prismaMock.tweet.findUnique.mockResolvedValue(tweet);
    prismaMock.tweet.findFirst.mockResolvedValue(retweetTweet);
  ...
  describe('get user mentioned tweets', () => {
    test('unlike existing tweet', async () => {
      ...
      const tweetCreated2 = {
        createdAt: new Date(),
        id: '351f773f-f214-4522-8e55-a17b6ddb63eg',
        text: 'Hello @ahmed',
        userId: '251f773f-f284-4522-8e55-a17b6ddb63ef',
        readCount: 1,
        replyCount: 1,
