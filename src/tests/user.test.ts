...
describe('delete /user/profile_banner', () => {
  ...
  test('should delete a profile picture', async () => {
    ...
    prismaMock.user.update.mockResolvedValue(user);
    const response = (await Request(app).delete('/api/v1/user/profile_picture').set('authorization', 'Bearer abc123'));;
  ...
  describe('delete /user/profile_picture', () => {
    ...
    test('should delete a profile banner', async () => {
      ...
      prismaMock.user.update.mockResolvedValue(user);
      const response = (await Request(app).delete('/api/v1/user/profile_banner').set('authorization', 'Bearer abc123'));;
...
describe('put /user/profile', () => {
  ...
  test('thsis  should send request with invalid url', async () => {
    ...
    prismaMock.user.update.mockResolvedValue(user)
    const res = await Request(app)
      .put('/api/v1/user/profile').send(payload)
      .set('authorization', 'Bearer abc123');
    expect(res.status).toBe(401);
...
describe('GET /user/suggestions', () => {
  ...
  test('should send photo and return  status 200', async () => {
    ...
    const response = (await Request(app).post('/api/v1/user/profile_picture').set('authorization', 'Bearer abc123').attach( 'photo',buffer,'imageMock/test.jpg'));;
  ...
  test('should send empty and return  status 500', async () => {
    ...
    prismaMock.user.update.mockResolvedValue(user);
    const response = (await Request(app).post('/api/v1/user/profile_picture').set('authorization', 'Bearer abc123'));;
    expect(response.status).toBe(500)
    expect(response.body.message).toEqual("An error occurred while uploading profile picture")
...
describe('POST /user/profile_banner', () => {
  ...
  test('should send photo and return  status 200', async () => {
    ...
    prismaMock.user.update.mockResolvedValue(user);
    const buffer = Buffer.from('some data');
    const response = (await Request(app).post('/api/v1/user/profile_banner').set('authorization', 'Bearer abc123').attach( 'photo',buffer,'imageMock/test.jpg'));;
    expect(response.body.message).toEqual("Image uploaded successfully")
    expect(response.status).toBe(200)
  ...
  test('should send empty and return  status 500', async () => {
    ...
    prismaMock.user.update.mockResolvedValue(user);
    const response = (await Request(app).post('/api/v1/user/profile_banner').set('authorization', 'Bearer abc123'));;
    expect(response.status).toBe(500)
    expect(response.body.message).toEqual("An error occurred while uploading profile picture")
